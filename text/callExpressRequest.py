...
partnerID = 'HYUYCM3N5'  # 此处替换为您在丰桥平台获取的顾客编码!
# checkword = 'eo7DWtx7XlMPLUFdWx46SKlp8QikuMJo'  #沙箱校验码
checkword = 'UfRUvfwi9uxM7zwS5J46xSJPenRi35bz'  # 此处替换为您在丰桥平台获取的校验码!
...
msgData['trackingNumber'] = 'SF1400675620201'
msgData = json.dumps(msgData)
# print(msgData,type(msgData))
# 关闭打开的文件
file.close()
